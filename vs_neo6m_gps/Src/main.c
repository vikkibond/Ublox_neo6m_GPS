 ...
 *
 * In this program:
 * 1. We Enable FPU, we use USART2 for debug purpose.
 ...
 *    we write new data received from module on a head position and clear out the tail
 *    position as we read from buffer (called from nmea_parser_lib).
 *
